...
bool MeowEngine::EnttTripleBuffer::ApplyAddRemoveOnStaging(MeowEngine::Physics::PhysicsSystem* inPhysics) {
    ...
    std::function<void(MeowEngine::Physics::PhysicsSystem*)> method;
