...
namespace MeowEngine {
    ...
    public:
         ...
         * @param inPhysics
         */
        bool ApplyAddRemoveOnStaging(MeowEngine::Physics::PhysicsSystem* inPhysics);
         ...
         */
        void ApplyPropertyChangeOnStaging(MeowEngine::Physics::PhysicsSystem* pPhysics);
    ...
    private:
         ...
         */
        moodycamel::ConcurrentQueue<std::function<void(MeowEngine::Physics::PhysicsSystem*)>> ComponentToAddOnStagingQueue;
    ...
    void MeowEngine::EnttTripleBuffer::AddComponentOnStaging(const entt::entity &inEntity, Args &&... inArgs) {
        ComponentToAddOnStagingQueue.enqueue([&, inEntity, inArgTuple = std::make_tuple(std::forward<Args>(inArgs)...)](MeowEngine::Physics::PhysicsSystem* inPhysics) {
            std::apply([&](auto&&... inUnpacked) {
